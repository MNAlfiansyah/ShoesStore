...
<body>
    <div class="header">
        <div><span class="head-title"><img src="./assets/image/shoes-logo.png" />Shoes Store</span></div>
        <div><span class="buy-now"><a href='#' class="head-title">Shop Now</a><span></div>
        <div><span><a href='#' class="head-title">About Us</a><span></div>
    </div>
    <div class="content">
